    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <a class="nav-link" href="./main.jsp">홈으로
            </a>
          </li>
          <li class="nav-item active">
            <a class="nav-link" href="./matchDisplay.jsp">매칭</a>
             <span class="sr-only">(current)</span>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="./bulletboard.jsp">게시판</a>
          </li>
          <li class="nav-item">
  ...
  <header class="bg-danger py-5 mb-5" style="opacity: 0.6;">
    <div class="container h-100">
      <div class="row h-100 align-items-center">
        <div class="col-lg-12">
          <h1 class="display-4 text-white mt-5 mb-2">MBTIng 매칭이 끝났습니다.</h1>
          <p class="lead mb-5 text-white-50">더이상 매칭 할 상대가 없습니다. 3초 후 메인화면으로 돌아갑니다...</p>
        </div>
      </div>
    </div>
  </header>
